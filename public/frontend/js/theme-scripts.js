        ...
        after: function (slider) {
            if (slider.currentItem == 0) {
                ...
                if (slider.transitions) {
                    ...
                    slider.container.css("-" + slider.pfx + "-transition-duration", "0.6s");
                    slider.container.css("transition-duration", "0.6s");
                }
...
tjq(window).load(function () {
    ...
    if (enableChaser == 1 && tjq('#content').length > 0 && tjq('#main-menu ul.menu').length > 0) {
        ...
        tjq('<h1 class="logo navbar-brand"><a title="KNOWLEDGE.VN" href="/"><img alt="" src="/public/frontend/images/logo.png"></a></h1>').insertBefore('.chaser .menu');
