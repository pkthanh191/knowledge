    ...
    n.fn.priceFormat = function (t) {
        ...
        return n(window).bind("keyup keydown", function (n) {
            ...
            function u(t, i) {
                ...
                var r = f(o(t)), e = "", a = 0;
                0 == _ && (y = "", c = "");
                var c = r.substr(r.length - _, _), s = r.substr(0, r.length - _);
            ...
            function a(n) {
                var t = n.keyCode ? n.keyCode : n.which, e = String.fromCharCode(t), o = !1, f = m, a = u(f + e);
            ...
            var h = n(this), m = "", v = /[0-9]/;
            m = h.is("input") ? h.val() : h.html();
            var g = t.prefix, w = t.suffix, y = t.centsSeparator, b = t.thousandsSeparator, x = t.limit, _ = t.centsLimit, S = t.clearPrefix, k = t.clearSuffix, F = t.allowNegative, O = t.insertPlusSign, P = t.clearOnEmpty, C = t.leadingZero;
