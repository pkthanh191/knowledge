...
@section('page_title')
    @include('frontend._partials.breadcrumbs', ['breadcrumbs' => Breadcrumbs::generate('centers')])
                ...
                <div class="col-sm-8 col-md-9">
                    <div class="sort-by-section clearfix">
                        <div class="row">
                            <div class="col-md-6">
                                <div class="row">
                                    <form action="{{ route('centers') }}" method="GET">
                    ...
                    @else
                        <div class="grid-mode" @if ($mode != "grid" && $mode != null) style="display: none;" @endif>
                            @include('frontend.centers.grid')
                        </div>

                        <div class="list-mode" @if ($mode != "list") style="display: none;" @endif>
                            @include('frontend.centers.list')
                        </div>
                    @endif
                </div>
