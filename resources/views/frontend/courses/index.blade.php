...
@section('page_title')
    @include('frontend._partials.breadcrumbs', ['breadcrumbs' => Breadcrumbs::generate('courses',$currentCategory)])
@endsection
                ...
                <div class="col-sm-8 col-md-9">
                    ...
                    @else
                        <div class="grid-mode" @if ($mode != "grid" && $mode != null) style="display: none;" @endif>
                            @include('frontend.courses.grid')
                        </div>

                        <div class="list-mode" @if ($mode != "list") style="display: none;" @endif>
                            @include('frontend.courses.list')
                        </div>
                    @endif
                </div>
            </div>
