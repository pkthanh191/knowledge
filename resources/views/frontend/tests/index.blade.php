...
@section('page_title')
    @include('frontend._partials.breadcrumbs', ['breadcrumbs' => Breadcrumbs::generate('tests',$currentCategory)])
@endsection
        ...
        <div id="main">
            <div class="row">
                <div class="col-sm-4 col-md-3">
                    @include('frontend._partials.menu-test-categories')
                </div>
