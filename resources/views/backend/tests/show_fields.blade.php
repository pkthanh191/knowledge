...
<div class="col-md-10" >
    {{--<img align="middle" style="margin-left:auto;margin-right: auto; display: block ;max-width: 360px; max-height: 500px ; border:1px solid dodgerblue" src="{{asset('/public/'.$test->image)}}" alt="{!! $test->name !!}">--}}
    ...
    @else
        <img style="margin-left:auto;margin-right: auto; display: block ;max-width: 360px; max-height: 500px ; border:1px solid dodgerblue" src="{{asset('/public/'.$test->image)}}" width="360px" height="360px">
    @endif
        <br>
</div>
<div class="col-md-1"></div>
