    ...
    <section class="content">
        ...
        <div class="box box-solid">
            <div class="box-header with-border">
                ...
                <div class="box-tools">
                    <a class="btn btn-primary" href="{!! route('admin.users.create') !!}"><i class="fa fa-plus"></i> @lang('messages.create')</a>
...
{{--                        {!! Form::text('search[address]', null, ['class' => 'form-control', 'placeholder' => Lang::get('messages.user_address')]) !!}--}}
                        ...
                        <a class="btn btn-warning" href="{!! route('admin.users.index') !!}"><i class="fa fa-eraser"></i> @lang('messages.reset')</a>
                    </div>
                    {!! Form::close() !!}
                </div>
            </div>
            <div class="box-body">
                {!! Form::open(['id' =>'items', 'route' => ['admin.users.destroy', 'MULTI'], 'method' => 'delete']) !!}
                {!! Form::close() !!}
