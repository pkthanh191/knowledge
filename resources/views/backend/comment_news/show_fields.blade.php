<div class="comments-container block">
    <div class="page-header"><h3>@lang('messages.news'): {{ $new->name }}</h3>
    </div>
    ...
    <ul id="comment_list" class="comment-list travelo-box">
        ...
        @else
            @foreach($new->comments as $key => $comment)
...
<form id="formDelete">
    {{ csrf_field() }}
    <input type="hidden" id="slug" name="slug" value="{{ $new->slug }}">
...
<div class="post-comment block">
    ...
    <div class="travelo-box">
        <form class="comment-form" id="comment">
            ...
            <a href="{!! route('admin.commentNews.index') !!}" class="btn btn-default"><i
