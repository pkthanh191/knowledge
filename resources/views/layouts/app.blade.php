...
@if (!Auth::guest())
    <div class="wrapper">
                        ...
                        <li class="dropdown user user-menu">
                            ...
                            <ul class="dropdown-menu">
                                ...
                                <li class="user-header">
                                    ...
                                    <p>
                                        {!! Auth::user()->name !!}
                                        <small>@lang('messages.user-join-at') {!! Auth::user()->created_at->format('d/m/Y') !!}</small>
                                    </p>
                                </li>
                                <!-- Menu Footer-->
                                <li class="user-footer">
                                    <div class="pull-left">
                                        <a href="{{route('admin.users.edit',Auth::user()->id) }}" class="btn btn-default btn-flat">@lang('auth.profile')</a>
                                    </div>
        ...
        <footer class="main-footer" style="max-height: 100px;text-align: center">
            <strong>Copyright © 2017 <a href="http://bloomgoo.vn">BLOOMGOO.VN</a>.</strong> All rights reserved.
        </footer>
